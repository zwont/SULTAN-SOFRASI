...
function toggleCat(el){
  ...
  document.querySelectorAll('.category').forEach(x=>{x.classList.remove('open');const p=x.querySelector('.plus');if(p)p.textContent='＋'});
  openCustomerCatKey=was?null:key;
